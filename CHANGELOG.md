...
- Fix lower bounds of dependencies.

## [1.2.11] - 2026-08-31

### Changed

- Update version bounds of dependencies.
...
- Add type hints to the entire package and perform type checking with `mypy`.
...
- Fix _examples/HF135/inverse1.py_ failure in some environments.
...
- Work around a SciPy bug that can cause `solve()` to fail with an unexpected `ValueError` (https://github.com/scipy/scipy/issues/17066).
...
[1.2.13]: https://github.com/gerlero/fronts/compare/v1.2.12...v1.2.13
[1.2.12]: https://github.com/gerlero/fronts/compare/v1.2.11...v1.2.12
[1.2.11]: https://github.com/gerlero/fronts/compare/v1.2.10...v1.2.11
[1.2.10]: https://github.com/gerlero/fronts/compare/v1.2.9...v1.2.10
...
[1.0.3]: https://github.com/gerlero/fronts/compare/v1.0.2...v1.0.3
[1.0.2]: https://github.com/gerlero/fronts/compare/v1.0.1...v1.0.2
[1.0.1]: https://github.com/gerlero/fronts/compare/v1.0.0...v1.0.1
